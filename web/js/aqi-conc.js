...
function PollutantUnit(form1) {
	...
	if (document.form1.pollutant.selectedIndex == '1' || document.form1.pollutant.selectedIndex == '2') {
		...
		document.form1.pollutant.selectedIndex == '4' ||
		document.form1.pollutant.selectedIndex == '5' ||
		document.form1.pollutant.selectedIndex == '6' ||
		form1.pollutant.selectedIndex == '7' ||
		form1.pollutant.selectedIndex == '8'
	) {
