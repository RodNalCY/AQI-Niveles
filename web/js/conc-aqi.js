...
function AQIOzone8hr(Concentration) {
	...
	if (c >= 0 && c < 0.055) {
		...
		AQI = Linear(100, 51, 0.07, 0.055, c);
		...
		AQI = Linear(300, 201, 0.2, 0.106, c);
...
function AQINO2(Concentration) {
	...
	if (c >= 0 && c < 0.054) {
		...
		AQI = Linear(100, 51, 0.1, 0.054, c);
	} else if (c >= 0.101 && c < 0.361) {
		AQI = Linear(150, 101, 0.36, 0.101, c);
	} else if (c >= 0.361 && c < 0.65) {
		AQI = Linear(200, 151, 0.649, 0.361, c);
	} else if (c >= 0.65 && c < 1.25) {
		AQI = Linear(300, 201, 1.249, 0.65, c);
	} else if (c >= 1.25 && c < 1.65) {
		AQI = Linear(400, 301, 1.649, 1.25, c);
	} else if (c >= 1.65 && c <= 2.049) {
		AQI = Linear(500, 401, 2.049, 1.65, c);
	} else {
		AQI = 'Out of Range';
	}
	return AQI;
...
function UnitDetermin(form2) {
	...
	if (document.form2.pollutant.selectedIndex == '1' || document.form2.pollutant.selectedIndex == '2') {
		...
		document.form2.pollutant.selectedIndex == '4' ||
		document.form2.pollutant.selectedIndex == '5' ||
		document.form2.pollutant.selectedIndex == '6' ||
		form2.pollutant.selectedIndex == '7' ||
		form2.pollutant.selectedIndex == '8'
	) {
...
function CalcAQI(form2) {
	...
	if (b == 'Out of Range') {
		...
		myWindowOofR.document.write(
			'<p>Note: Values above 500 are considered Beyond the AQI. Follow recommendations for the Hazardous category</p>'
		);
		document.form2.inputbox.value = ' ';
		document.form2.outputbox1.value = ' ';
		document.form2.outputbox3.value = ' ';
		...
		myWindowSO1.document.write(
			'<p>AQI values of 201 or greater are calculated with 24-hour SO2 concentrations.</p>'
		);
		document.form2.inputbox.value = ' ';
		document.form2.outputbox1.value = ' ';
		document.form2.outputbox3.value = ' ';
		...
		myWindowo3.document.write(
			'<p>8-hour ozone values do not define higher AQI values (>=301).</p><p> AQI values of 301 or greater are calculated with 1-hour ozone concentrations.</p>'
		);
		document.form2.inputbox.value == '';
		document.form2.outputbox1.value == '';
		document.form2.outputbox3.value == '';
		...
		var myWindowo3 = window.open('', '', 'width=450,height=75,left=450,menubar=no,top=200');
		myWindowo3.document.write(
			'<p>1-hour ozone values do not define lower AQI values (<= 100).  AQI values of 100 or lower are calculated with 8-hour ozone concentrations.</p>'
		);
		document.form2.inputbox.value == '';
		document.form2.outputbox1.value == '';
		document.form2.outputbox3.value == '';
		...
		myWindowPM.document.write(
			"<p>Note: Values above 500 are considered Beyond the AQI.</p><p>Additional information on reducing exposure to extremely high levels of particle pollution is available <a href='https://airnow.gov/index.cfm?action=aqibasics.pmhilevels'target='_blank'>here</a>.</p>"
		);
		document.form2.inputbox.value == '';
		document.form2.outputbox1.value == '';
		document.form2.outputbox3.value == '';
	...
	if (document.form2.outputbox3.value == 'Good') {
		...
		if (document.form2.pollutant.selectedIndex == '1') {
			...
			if (document.form2.pollutant.selectedIndex == '6') {
				...
				document.form2.Cautionary.value =
					'Active children and adults, and people with respiratory disease, such as asthma, should limit heavy outdoor exertion.';
			}
		} else if (document.form2.pollutant.selectedIndex == '8') {
			document.form2.TextSensitive.value =
				'People with asthma or other respiratory diseases, the elderly, and children are the groups most at risk.';
		...
		if (document.form2.pollutant.selectedIndex == '1') {
			...
			document.form2.TextSensitive.value = 'People with heart disease are the group most at risk.';
			document.form2.HealthEffects.value =
				'Reduced exercise tolerance due to increased cardiovascular symptoms, such as chest pain, in people with cardiovascular disease.';
			document.form2.Cautionary.value =
				'People with cardiovascular disease, such as angina, should limit moderate exertion and avoid sources of CO, such as heavy traffic.';
		} else if (document.form2.pollutant.selectedIndex == '4' || form2.pollutant.selectedIndex == '5') {
			document.form2.TextSensitive.value = 'People with asthma are the group most at risk.';
			document.form2.HealthEffects.value =
			...
			document.form2.Cautionary.value =
				'Children, asthmatics, and people with heart or lung disease should limit outdoor exertion.';
		} else if (document.form2.pollutant.selectedIndex == '6' || form2.pollutant.selectedIndex == '7') {
			document.form2.TextSensitive.value = 'Children and people with asthma are the groups most at risk.';
			document.form2.HealthEffects.value =
		...
		if (document.form2.pollutant.selectedIndex == '1') {
			...
			document.form2.TextSensitive.value =
				'People with asthma or other respiratory diseases, the elderly, and children are the groups most at risk.';
			document.form2.HealthEffects.value =
				'Severe respiratory effects and impaired breathing likely in active children, the elderly, and people with lung disease, such as asthma; increasingly severe respiratory effects likely in general population.';
			document.form2.Cautionary.value =
